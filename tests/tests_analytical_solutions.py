...
def make_solver(pulse: str, *, M: int, N: int) -> Solver:
    ...
    com = CP(N=N, M=M, L1=0.0, L2=1.0, T1=-30.0, T2=30.0, damp_length=0.0, method="ssfm_order2_dnd_short_julia")  
    # ssfm_order2_dnd_short, ssfm_order2_dnd_short_julia, ssfm_order2_ndn_by_julia
