...
def _need_torch():
    raise RuntimeError(
        "Вызван rk4_step_torch, но PyTorch недоступен. "
        "Установите torch или используйте NumPy-реализацию RK4."
    )


if not _TORCH_AVAILABLE:
    def rk4_step_torch(*args, **kwargs):
        _need_torch()
    def rk4_implicit_step_torch(*args, **kwargs):
        _need_torch()
else:
